    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
        <section>
            ...
            <div class="mb-4">
                ...
                <x-text-input readonly id="customer_name" name="customer_name" type="text" class="mt-1 block w-full"
                    :value="old('customer_name', $sales->customer_name)" autocomplete="" />
                <x-input-error :messages="$errors->get('customer_name')" class="mt-2" />
            </div>

            <div class="mb-4">
                <x-input-label for="customer_family_card_no" :value="__('Family Card No')" />
                <x-text-input readonly id="customer_family_card_no" name="customer_family_card_no" type="text"
                    class="mt-1 block w-full" :value="old('customer_family_card_no', $sales->customer_family_card_no)" autocomplete="customer_family_card_no" />
            ...
            <x-text-input readonly id="customer_phone_no" name="customer_phone_no" type="text"
            ...
            <div class="mb-4">
                ...
                <x-text-input readonly id="customer_full_address" name="customer_full_address" type="textarea"
            ...
            <x-text-input readonly id="sales_date" name="sales_date" type="date"
            ...
            <x-text-input readonly id="sales_code" name="sales_code" type="text"
                class="mt-1 block w-full" :value="old('sales_code', $sales->sales_code)" />
...
<div class="w-1/2 mx-auto sm:px-6 lg:px-8 space-y-6">
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
        <section>
            ...
            <x-text-input readonly id="motor_plate_number" name="motor_plate_number" type="text"
                class="mt-1 block w-full" :value="old('motor_plate_number', $sales->motor_plate_number)" autocomplete="" />
            <x-input-error :messages="$errors->get('motor_plate_number')" class="mt-2" />
            </div>

            <div class="mb-4">
                <x-input-label for="motor_type" :value="__('Type')" />
                <x-text-input readonly id="motor_type" name="motor_type" type="text" class="mt-1 block w-full"
            ...
            <x-text-input readonly id="motor_frame_number" name="motor_frame_number" type="text" class="mt-1 block w-full"
                :value="old('motor_frame_number', $sales->motor_frame_number)" autocomplete="" />
            ...
            <x-text-input readonly id="motor_engine_number" name="motor_engine_number" type="text" class="mt-1 block w-full"
                :value="old('motor_engine_number', $sales->motor_engine_number)" autocomplete="" />
            ...
            <x-text-input readonly id="motor_assemble_year" name="motor_assemble_year" type="text" class="mt-1 block w-full"
                :value="old('motor_assemble_year', $sales->motor_assemble_year)" autocomplete="" />
            <x-input-error :messages="$errors->get('motor_assemble_year')" class="mt-2" />
            </div>

            <div class="mb-4">
            <x-input-label for="motor_color" :value="__('Color')" />
            <x-text-input readonly id="motor_color" name="motor_color" type="text" class="mt-1 block w-full"
            ...
            <div class="mb-4">
                ...
                <x-text-input readonly id="motor_price" name="motor_price" type="number" class="mt-1 block w-full"
