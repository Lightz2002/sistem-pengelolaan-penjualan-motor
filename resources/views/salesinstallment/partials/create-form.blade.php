<form method="post" action="{{ route('salesinstallment.store', ['sales' => $sales->id]) }}" class="p-6 grid grid-cols-2">
    @csrf
            ...
            <section>
                ...
                <div class="mb-4">
                    ...
                    <x-text-input readonly id="receipt_date" name="receipt_date" type="text" class="mt-1 block w-full"
                        :value="old('receipt_date', $additionalDatas->receipt_date)" autocomplete="" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input readonly id="code" name="code" type="text"
                        class="mt-1 block w-full" :value="old('code', $additionalDatas->code)" autocomplete="code" />
            ...
            <section>
                ...
                <div class="mb-4">
                    ...
                    <x-text-input readonly id="due_date" name="due_date" type="text" class="mt-1 block w-full"
                        :value="old('due_date', $additionalDatas->due_date)" autocomplete="" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input readonly id="late_payment_days" name="late_payment_days" class="mt-1 block w-full"
                        :value="old('late_payment_days', $additionalDatas->late_payment_days)" autocomplete="" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input readonly id="fine" name="fine" class="mt-1 block w-full"
                        :value="old('fine', $additionalDatas->fine)" autocomplete="" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input readonly id="penalty_debt" name="penalty_debt" class="mt-1 block w-full"
                        :value="old('penalty_debt', $additionalDatas->penalty_debt)" autocomplete="" />
                ...
                <div class="mb-4">
                    ...
                    <div class="flex">
                        <x-text-input id="Office" name="pay_in" type="radio" class="mt-1 me-1 block"
                            autocomplete="Office" value="Office" :checked="old('pay_in') === 'Office'" />
                    ...
                    <div class="flex">
                        <x-text-input id="Collector" name="pay_in" type="radio" class="mt-1 me-1 block"
                            autocomplete="Collector" value="Collector" :checked="old('pay_in') === 'Collector'" />
                ...
                <div class="mb-4">
                    ...
                    <div class="flex">
                        <x-text-input id="Cash" name="account" type="radio" class="mt-1 me-1 block"
                            autocomplete="Cash" value="Cash" :checked="old('account') === 'Cash'" />
                    ...
                    <div class="flex">
                        <x-text-input id="BCA" name="account" type="radio" class="mt-1 me-1 block"
                            autocomplete="BCA" value="BCA" :checked="old('account') === 'BCA'" />
                    ...
                    <div class="flex">
                        <x-text-input id="BRI" name="account" type="radio" class="mt-1 me-1 block"
                            autocomplete="BRI" value="BRI" :checked="old('account') === 'BRI'" />
            ...
            <section class="p-1">
                <div class="mt-12 mb-4 flex">
                    <div class="w-1/2 me-2">
                        ...
                        <x-text-input readonly id="period_no" name="period_no" type="text" class="mt-1 block w-full"
                            :value="old('period_no', $additionalDatas->period_no)" autocomplete="" />
                    ...
                    <div class="w-1/2">
                        ...
                        <x-text-input readonly id="period_left" name="period_left" type="text" class="mt-1 block w-full"
                            :value="old('period_left', $additionalDatas->period_left)" autocomplete="" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="discount_amount" name="discount_amount" type="text" class="mt-1 block w-full"
                        :value="old('discount_amount')" autocomplete="" />
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="paid_fine" name="paid_fine" type="text" class="mt-1 block w-full"
                        :value="old('paid_fine')" autocomplete="" />
